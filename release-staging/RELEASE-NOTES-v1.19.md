...
This release refreshes LinkGuard's app icon and makes link scanning faster, more predictable, and safer during slow or unreliable network conditions.

## What's improved

- Refreshed LinkGuard launcher and adaptive app icon, with a matching icon in the app header.
...
Detection rules, scoring thresholds, provider mappings, trusted-domain lists, database behavior, and API configuration are unchanged.
